...
class TenMinuteResponse(list):

    def __init__(self, month, day, ticker):
        super().__init__()
        self.date = month, day
        self.ticker = ticker
        self.__ten_request(*self.date, self.ticker)

    def __ten_request(self, month: str, day: str, ticker: str):
        ...
        self.append(response_10.json()['candles']['data'][1:])

        return


class OneMinuteResponse(list):
    ...
    def __ten_request(self, month: str, day: str, ticker: str):
        ...
        self.append(response_1.json()['candles']['data'][::-1])

        return


class TrimmedResponsesList(list):

    def __init__(self, response_10, response_1):
        super().__init__()
        self.__response_10 = response_10
        self.__response_1 = response_1
        self.__trim_responses(self.__response_10, self.__response_1)

    def __trim_responses(self, response_10: list, response_1: list) -> None:
        ...
        self.append((response_10, response_1))

        return  # response_10, response_1


class MoexResponses(list):
    ...
    def __init__(self, month, day, ticker):
        ...
        # self = [self.__trim_responses(*self.__receive_data(*self.date, ticker))]
        self.__self_change()
        print(dir(list))
        print(dir(self)[4:])
        print(type(self))

    def __self_change(self):
        self = [self.__trim_responses(*self.__receive_data(*self.date, self.ticker))]

    def __receive_data(self, month: str, day: str, ticker: str) -> tuple[list, list]:
